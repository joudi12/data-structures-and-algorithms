...
const mapCurrentEvents = () => {
  // Solution code here...
  let result = currentEvents.news.map(value=>{
    let movieObject = new Event(value);
    return movieObject;
});
return result;
}
...
const countNumberOfElements = (arr) => {
 return arr.reduce(function(accumulator){
...
const reversedString = (str) => {
  ...
  let result= index.reduce( function(accumulator,value,idx) {
